...
const Servicios = () => {
  ...
  return (
    <div className="site-wrap services-page-premium">
      ...
      {/* Webtracking Interactive Module */}
      <div className="webtracking-module" id="webtracking-section">
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6" data-aos="fade-right">
              <motion.div 
                className="webtracking-visual"
                whileHover={{ scale: 1.02 }}
                transition={{ duration: 0.3 }}
              >
                <img 
                  src="/images/1209.jpg" 
                  alt="Webtracking System" 
                  className="img-fluid rounded-lg shadow-xl"
                />
                <div className="webtracking-badge">
                  <Shield size={20} />
                  <span>{t('servicesPage.webtracking.badge', 'Tracking 24/7')}</span>
                </div>
              </motion.div>
            </div>

            <div className="col-lg-6" data-aos="fade-left">
              <div className="webtracking-content">
                <h2 className="webtracking-title">
                  {t('servicesPage.webtracking.title', 'WEBTRACKING')}
                </h2>
                <p className="webtracking-subtitle">
                  {t('servicesPage.webtracking.subtitle', 'Monitorea tu carga en tiempo real')}
                </p>
                <p className="webtracking-description">
                  {t('servicesPage.webtracking.description', 'Accede a la ubicación exacta de tu carga, documentos digitalizados y actualizaciones en tiempo real. Control total desde cualquier dispositivo.')}
                </p>

                <div className="webtracking-features">
                  <div className="tracking-feature" data-aos="fade-up" data-aos-delay="100">
                    <div className="feature-icon">
                      <MapPin size={24} />
                    </div>
                    <div className="feature-text">
                      <h4>{t('servicesPage.webtracking.feature1Title', 'Ubicación GPS')}</h4>
                      <p>{t('servicesPage.webtracking.feature1Desc', 'Seguimiento preciso en cada etapa')}</p>
                    </div>
                  </div>
                  ...
                  <div className="tracking-feature" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div className="feature-text">
                      <h4>{t('servicesPage.webtracking.feature2Title', 'Documentos')}</h4>
                      <p>{t('servicesPage.webtracking.feature2Desc', 'Acceso digital a toda la documentación')}</p>
                    </div>
                  </div>
                  ...
                  <div className="tracking-feature" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div className="feature-text">
                      <h4>{t('servicesPage.webtracking.feature3Title', 'Notificaciones')}</h4>
                      <p>{t('servicesPage.webtracking.feature3Desc', 'Alertas automáticas de cada milestone')}</p>
                    </div>
                  </div>
                </div>
                ...
                <motion.a 
                  ...
                  className="btn btn-lg btn-webtracking"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <ArrowRight size={20} className="me-2" />
                  {t('servicesPage.webtracking.cta', 'Acceder al Sistema')}
                </motion.a>
              </div>
            </div>
          </div>
        ...
        <div className="container text-center">
          ...
          >
            ...
            <div className="final-cta-buttons">
              ...
              <Link to="/nuevos-clientes" className="btn btn-outline-light btn-lg">
