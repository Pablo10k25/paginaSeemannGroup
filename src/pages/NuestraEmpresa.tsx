    ...
    <div className="site-wrap" style={{ backgroundColor: '#f8f9fa' }}>
                ...
                <div className="row g-0">
                  <div className="col-lg-5">
                    <div 
                      className="h-100"
                      style={{
                        backgroundImage: "url('https://images.unsplash.com/photo-1553413077-190dd305871c?w=800&h=900&fit=crop')",
                        backgroundSize: 'cover',
                        backgroundPosition: 'center',
                        minHeight: '400px'
                      }}
              ...
              >
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundImage: "url('https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=800&h=600&fit=crop')",
                      backgroundSize: 'cover',
                      backgroundPosition: 'center'
                    }}
                  />
              ...
              >
                ...
                >
                  <div
                    className="w-100 h-100"
                    style={{
                      backgroundImage: "url('https://images.unsplash.com/photo-1557804506-669a67965ba0?w=800&h=600&fit=crop')",
                      backgroundSize: 'cover',
                      backgroundPosition: 'center'
                    }}
                  />
      ...
      <section className="py-5 bg-white">
        <div className="container">
          ...
          >
            <motion.div className="text-center mb-5" variants={fadeInUp}>
              <span className="text-danger text-uppercase fw-semibold" style={{ letterSpacing: '2px', fontSize: '0.85rem' }}>
                {t('ourCompany.gallery.subtitle')}
              </span>
              <h2 className="display-5 fw-bold mt-2">{t('ourCompany.gallery.title')}</h2>
            </motion.div>
